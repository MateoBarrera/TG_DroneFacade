...
class Matrice100Services:
    ...
    def goHome(self):
        ...
        try:
            ...
            print("Service Go Home call failed: %s"%e)
    ...
    def startMission(self):
        ...
        try:
            ...
            print("Service Start WP Mission call failed: %s"%e)
    ...
    def stopMission(self):
        ...
        try:
            ...
            print("Service Stop WP Mission call failed: %s"%e)
    ...
    def pauseMission(self):
        ...
        try:
            ...
            print("Service Pause WP Mission call failed: %s"%e)
    ...
    def resumeMission(self):
        ...
        try:
            ...
            print("Service Resume WP Mission call failed: %s"%e)
    ...
    def uploadMission(self):
        ...
        try:
            ...
            print("Service Upload WP Mission call failed: %s"%e)
    ...
    def getInfoMission(self):
        ...
        try:
            ...
            print("Service Get Mission WP Info Mission call failed: %s"%e)
            return None
    ...
    def getSpeedMission(self):
        ...
        try:
            ...
            print("Service Get Speed WP Mission call failed: %s"%e)
            return None
    ...
    def setSpeedMission(self, speed):
        ...
        try:
            ...
            print("Service Set Speed WP Mission call failed: %s"%e)
