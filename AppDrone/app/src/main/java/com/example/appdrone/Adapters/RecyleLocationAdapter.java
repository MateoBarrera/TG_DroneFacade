package com.example.appdrone.Adapters;
...
import com.example.appdrone.GGA;
...
public class RecyleLocationAdapter extends RecyclerView.Adapter<RecyleLocationAdapter.ViewHolder> {
    ...
    public   class  ViewHolder extends RecyclerView.ViewHolder{
        ...
        /*public ViewHolder(View itemView) {
            super(itemView);
            latitudeText = (TextView) itemView.findViewById(R.id.latView);
            longitudeText = (TextView) itemView.findViewById(R.id.longView);
            ...
            deleteButton=(ImageButton) itemView.findViewById(R.id.borrar_btn);
        }*/
        public ViewHolder(View itemView) {
            super(itemView);
